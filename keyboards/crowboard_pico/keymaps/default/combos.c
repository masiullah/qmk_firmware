...
combo_t key_combos[] = {
    [COMBO_1] =COMBO(combo1, MO(4)),
    [COMBO_2] =COMBO(combo2, MO(5)),
    [COMBO_3] =COMBO(combo3, TG(6)),
    [COMBO_4] =COMBO(combo4, TG(6)),
    [COMBO_5] =COMBO(combo5, TG(7)),
    [COMBO_6] =COMBO(combo6, TG(7)),
};
#endif
